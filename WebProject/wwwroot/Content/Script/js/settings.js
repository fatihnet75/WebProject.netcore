var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            //+ '<a href="#" class="active" data-theme="css/theme-default.css"><img src="../../Image/img/themes/default.jpg"/></a>'
            //+ '<a href="#" data-theme="css/theme-forest.css"><img src="../../Image/img/themes/forest.jpg"/></a>'
            //+ '<a href="#" data-theme="css/theme-dark.css"><img src="../../Image/img/themes/dark.jpg"/></a>'
            //+ '<a href="#" data-theme="css/theme-night.css"><img src="../../Image/img/themes/night.jpg"/></a>'
            //+ '<a href="#" data-theme="css/theme-serenity.css"><img src="../../Image/img/themes/serenity.jpg"/></a>'
            
            //+ '<a href="#" data-theme="css/theme-default-head-light.css"><img src="../../Image/img/themes/default-head-light.jpg"/></a>'
            //+ '<a href="#" data-theme="css/theme-forest-head-light.css"><img src="../../Image/img/themes/forest-head-light.jpg"/></a>'
            //+ '<a href="#" data-theme="css/theme-dark-head-light.css"><img src="../../Image/img/themes/dark-head-light.jpg"/></a>'
            //+ '<a href="#" data-theme="css/theme-night-head-light.css"><img src="../../Image/img/themes/night-head-light.jpg"/></a>'
            //+ '<a href="#" data-theme="css/theme-serenity-head-light.css"><img src="../../Image/img/themes/serenity-head-light.jpg"/></a>'
...
$('.clickEmre').click(function () {
    $('.clickEmre').removeClass('clicked');
    $(this).addClass('clicked');
});


//$('#ornekModal').on('show.bs.modal', function (e) { // triggered when showing the modal
//    var data = $('.clicked').attr('data');
   
//    $('#AltMenuler').html("");
//        var ID = parseInt(data);
//        $.ajax({
//            url: '/DijitalDonusum/AltKategorileriGetir/' + ID,
//            type: 'POST',
//            dataType: 'json',
...
//                        "<td>" + item.Sira + "</td>" +
//                        "<td>" + ctrl + "</td>" +
//                        "<td><a onclick='ConfirmDelete()' class='btn btn-info btn-sm' href='#" + item.Id + "'>Duzenle</a>" +
//                        "     <a class='btn btn-info btn-sm' href='/Admin/IcerikYonetimi/UstMenuSil/" + item.Id + "'>Sil</a></td></tr>"
//                        );
//                });
        ...
        success: function (data) {
            ...
            $.each(data, function (i, item) {
                ...
                $("#AltMenuler").append(
                    ...
                    "<td>" + ctrl + "</td>" +
                    "<td>" + ctrl2 + "</td>" +
                    "<td><a class='btn btn-info btn-sm' href='/Admin/IcerikYonetimi/UstMenuDuzenle/" + item.Id + "'>Duzenle</a>" +
                    "     <a onclick='ConfirmDelete(" + item.Id + ")' class='btn btn-info btn-sm'>Sil</a></td></tr>"
                    );
            });
...
function ConfirmDeleteParam(itemId,yer) {
    var x = confirm("Kaydi silmek istediginizden emin misiniz ?");
    if (x) {
        location.href = yer + itemId;
        return true;
    }
    else
        return false;
...
function ConfirmDelete(itemId) {
    var x = confirm("Kaydi silmek istediginizden emin misiniz ?");
    if (x) {
        location.href = "/Admin/IcerikYonetimi/UstMenuSil/" + itemId;
        return true;
    }
    else
        return false;
